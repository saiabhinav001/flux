                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="absolute right-0 top-full mt-3 w-64 bg-[#0A0A0A]/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden z-50 p-2 ring-1 ring-white/5"
                        >
